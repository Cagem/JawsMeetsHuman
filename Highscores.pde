...
void drawHighscores(){
  ...
  textAlign(LEFT);
  text("How long can you survive?", width * 0.87, height * 0.27, width * 0.06, height * 0.4); 
  text( "1:  " + nf(highscores[4]), width * 0.87, height * 0.4);   
  text( "2:  " + nf(highscores[3]), width * 0.87, height * 0.43);
  text( "3:  " + nf(highscores[2]), width * 0.87, height * 0.46);
  text( "4:  " + nf(highscores[1]), width * 0.87, height * 0.49);
  text( "5:  " + nf(highscores[0]), width * 0.87, height * 0.52);
}